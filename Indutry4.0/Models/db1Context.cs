...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:indusdemo.database.windows.net,1433;Initial Catalog=db1;Persist Security Info=False;User ID=demo;Password=Industry2021;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=60;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FeedbackPost>(entity =>
            {
                ...
                entity.Property(e => e.CanIncreaseAgree).HasColumnName("canIncreaseAgree");

                entity.Property(e => e.CanIncreaseDisagree).HasColumnName("canIncreaseDisagree");

                entity.Property(e => e.CompanyOrganizationName).IsRequired();
